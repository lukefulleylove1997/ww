...
class Index extends React.Component{
    ...
    render(){
        ...
        if(this.props.pageInfoData.appSettings['antserver_media_singlekey'] == 1){
            formFields.push(
                { key: "streamURL", label: "RTMP URL", value: "rtmp://"+(this.props.pageInfoData.liveStreamingServerURL ? this.props.pageInfoData.liveStreamingServerURL.replace("https://","").replace("http://","") : "")+`/${this.props.pageInfoData.streamingAppName}`,props:{readOnly: true}},
