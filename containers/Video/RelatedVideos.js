            ...
            <React.Fragment>
                ...
                }
                {
                    this.state.videos.map(video => {
                        ...
                        if(this.props.pageInfoData.livestreamingtype == 0 && video.mediaserver_stream_id &&  !video.orgImage && video.is_livestreaming == 1 && parseInt(this.props.pageInfoData.appSettings['antserver_media_hlssupported']) == 1){
                            if(this.props.pageInfoData.liveStreamingCDNServerURL){
                                videoImage = `${this.props.pageInfoData.liveStreamingCDNServerURL}/${this.props.pageInfoData.streamingAppName}/previews/${video.mediaserver_stream_id}.png`
                            }else{
                                videoImage = `${this.props.pageInfoData.liveStreamingServerURL}:5443/${this.props.pageInfoData.streamingAppName}/previews/${video.mediaserver_stream_id}.png`  
                            }
                            ...
                            if(this.props.pageInfoData.liveStreamingCDNURL){
                                videoImage = `${this.props.pageInfoData.liveStreamingCDNURL}${video.image.replace(`/LiveApp`,'').replace(`/WebRTCAppEE`,'')}`
                            }else
