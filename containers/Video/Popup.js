                                        ...
                                        >
                                        {
                                            this.state.content.map(result =>{
                                                ...
                                                if(result.image.indexOf("http://") == 0 || result.image.indexOf("https://") == 0){
                                                    ...
                                                    if(this.props.pageInfoData.livestreamingtype == 0 && result.mediaserver_stream_id &&  !result.orgImage && result.is_livestreaming == 1 && parseInt(this.props.pageInfoData.appSettings['antserver_media_hlssupported']) == 1){
                                                        if(this.props.pageInfoData.liveStreamingCDNServerURL){
                                                            videoImage = `${this.props.pageInfoData.liveStreamingCDNServerURL}/${this.props.pageInfoData.streamingAppName}/previews/${result.mediaserver_stream_id}.png`
                                                        }else
                                                            videoImage = `${this.props.pageInfoData.liveStreamingServerURL}:5443/${this.props.pageInfoData.streamingAppName}/previews/${result.mediaserver_stream_id}.png`
                                                    }else if(this.props.pageInfoData.livestreamingtype == 0 && result.mediaserver_stream_id &&  result.image && result.image.indexOf(`${this.props.pageInfoData.streamingAppName}/previews`) > 0){
                                                        if(this.props.pageInfoData.liveStreamingCDNURL){
                                                            imageUrl = this.props.pageInfoData.liveStreamingCDNURL+result.image.replace(`/LiveApp`,'').replace(`/WebRTCAppEE`,'')
                                                        }else
                                    ...
                                    >
                                    {
                                        this.state.myContent.map(result =>{
                                            ...
                                            if(result.image.indexOf("http://") == 0 || result.image.indexOf("https://") == 0){
                                                ...
                                                if(this.props.pageInfoData.livestreamingtype == 0 && result.mediaserver_stream_id &&  result.image && result.image.indexOf(`${this.props.pageInfoData.streamingAppName}/previews`) > 0){
                                                    if(this.props.pageInfoData.liveStreamingCDNURL){
                                                        imageUrl = this.props.pageInfoData.liveStreamingCDNURL+result.image.replace(`/LiveApp`,'').replace(`/WebRTCAppEE`,'')
                                                    }else
                                                        imageUrl = this.props.pageInfoData.liveStreamingServerURL+":5443"+result.image
