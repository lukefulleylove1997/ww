...
class Index extends React.Component{
    ...
    render(){ 
        ...
        if(this.state.type == "movies-series"){
            ...
            return (
                <React.Fragment>
                    <Breadcrum {...this.props}  onChange={this.onChange} subcategories={this.state.subcategories} subsubcategories={this.state.subsubcategories} image={this.state.category.image ? this.state.category.image : this.props.pageInfoData.appSettings["movie_category_default_photo"]} title={this.state.category.title} />
