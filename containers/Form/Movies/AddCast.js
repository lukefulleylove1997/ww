...
class AddCast extends Component {
    ...
    render(){
        ...
        if(!this.props.isCrew){
            ...
            formFields.push(
                { key: "job", type:"autosuggest",departmentJob:this.props.pageInfoData.departments, label: "Job", value: this.state.editItem ? this.state.editItem.job : null ,isRequired:true},
