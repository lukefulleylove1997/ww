                            ...
                            <div className="col-md-12">        
                                ...
                                </button>     
                                {
                                    ...
                                    <InfiniteScroll
                                        ...
                                        endMessage={
                                            <EndContent {...this.props} text={this.props.pageInfoData.search ?  Translate(this.props,'No video found with your matching criteria.') : Translate(this.props,'No video created yet.')} itemCount={this.state.videos.length} />
                                        }
                                            ...
                                            <table className="table custTble1">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        {
                                                            this.props.pageInfoData.selectType == "movie" ? 
                                                            ...
                                                            this.state.videos.map((video,index) => {
                                                                return (
                                                                    <tr key={video.movie_video_id}>
                                                                        <td>
                                                                        <Image className="img" image={video.image} imageSuffix={this.props.pageInfoData.imageSuffix} />
                                                                                {video.title}
                                                                        </td>
                                                                        <td>
                                                                                {video.type}
