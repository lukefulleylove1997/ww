                    ...
                    <div className="col-md-12 position-relative">
                        <div className="channelInfo-wrap artistDetailsWrap">
                            <div className="playlist-profile-img">
                                <Image title={this.state.cast.title} image={renderToString(<CensorWord {...this.props} text={this.state.cast.image} />)} imageSuffix={this.props.pageInfoData.imageSuffix} />
                            </div>
                            ...
                            <div className="LikeDislikeWrap">
                                <ul className="LikeDislikeList">
                                    ...
                                    <SocialShare {...this.props} hideTitle={true} buttonHeightWidth="30" url={`/cast-and-crew/${this.state.cast.cast_crew_member_id}`} title={renderToString(<CensorWord {...this.props} text={this.state.cast.title} />)} imageSuffix={this.props.pageInfoData.imageSuffix} media={this.state.cast.image} />
                                </ul>
                            </div>
                            </div>
                        </div>
