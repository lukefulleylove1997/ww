    ...
    render(){
        ...
        return (            
            <React.Fragment>
                    ...
                    this.state.episode && this.state.seasons ? 
                        <React.Fragment>
                            ...
                            <div className="tabInTitle">
                                ...
                                <div className="owner_name">
                                    <Link href="/watch" customParam={`videoId=${this.state.movie.custom_url}`} as={`/watch/${this.state.movie.custom_url}`}>
                                        <a>
                            ...
                            <div className="tabInTitle">
                                ...
                                <div className="owner_name">
                                    <Date {...this.props} creation_date={this.state.episode.release_date} initialLanguage={this.props.initialLanguage} format={'dddd, MMMM Do YYYY'} defaultTimezone={this.props.pageInfoData.defaultTimezone} />
                                </div>
                            </div>
                            <div className="tabInTitle">
                ...
                <React.Fragment>
                    {
                    this.props.pageInfoData.appSettings[`${"movie_rating"}`] == 1 && this.state.movie.approve == 1 ?
                        <div className="tabInTitle">
                    ...
                    }
                    {
                        this.state.movie.budget > 0 ? 
                            <div className="tabInTitle">
                                ...
                                <div className="owner_name">
                                    <React.Fragment>
                                    {`${ReactDOMServer.renderToStaticMarkup(<Currency { ...this.props } {...perpriceB} />)}`}
                                    </React.Fragment>
                                </div>
                            </div>
                    : null
                    }
                    {
                        this.state.movie.revenue > 0 ? 
                            <div className="tabInTitle">
                                ...
                                <div className="owner_name">
                                    <React.Fragment>
                                    {`${ReactDOMServer.renderToStaticMarkup(<Currency { ...this.props } {...perpriceR} />)}`}
                                    </React.Fragment>
                                </div>
                            </div>
                    : null
                    ...
                    <div className="tabInTitle">
                        <h6>{Translate(this.props, "Release Date")}</h6>
                        <div className="owner_name">
                            <Date {...this.props} creation_date={this.state.movie.movie_release} initialLanguage={this.props.initialLanguage} format={'dddd, MMMM Do YYYY'} defaultTimezone={this.props.pageInfoData.defaultTimezone} />
                        </div>
                    </div>
                    {
                        ...
                        <React.Fragment>
                            ...
                            <div className="boxInLink">
                            {
                                <Link href={`/category`} customParam={`type=movies-series&categoryId=` + this.state.movie.categories.slug} as={`/movies-series/category/` + this.state.movie.categories.slug}>
                                <a>
                            ...
                            </div>
                            {
                                ...
                                <React.Fragment>
                                    {/* <span> >> </span> */}
                                    <div className="boxInLink">
                                    <Link href={`/category`} customParam={`type=movies-series&categoryId=` + this.state.movie.subcategory.slug} as={`/movies-series/category/` + this.state.movie.subcategory.slug}>
                                    <a>
                                    ...
                                    this.state.movie.subsubcategory ?
                                        ...
                                        {/* <span> >> </span> */}
                                        <div className="boxInLink">
                                        <Link href={`/category`} customParam={`type=movies-series&categoryId=` + this.state.movie.subsubcategory.slug} as={`/movies-series/category/` + this.state.movie.subsubcategory.slug}>
                                            <a>
                            ...
                            <ul className="TabTagList clearfix">
                                ...
                                this.state.movie.movie_countries.map(country => {
                                    ...
                                    <li key={country.movie_country_id}>
                                        <Link href={`${this.props.pageInfoData.contentType == "movies" ? "movies" : "series"}`} customParam={`country=${country.country_id}`} as={`/${this.props.pageInfoData.contentType == "movies" ? "movies" : "series"}?country=${country.country_id}`}>
                        ...
                        <div className="blogtagListWrap">
                            ...
                            <ul className="TabTagList clearfix">
                                ...
                                this.state.movie.tags.split(',').map(tag => {
                                    return (
                                    <li key={tag}>
                                        <Link href={`${this.props.pageInfoData.contentType == "movies" ? "movies" : "series"}`} customParam={`tag=${tag}`} as={`/${this.props.pageInfoData.contentType == "movies" ? "movies" : "series"}?tag=${tag}`}>
