...
class Browse extends React.Component {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if (prevState.localUpdate){
            ...
            return {slideshow:nextProps.pageInfoData.slideshow, movies: nextProps.movies, pagging: nextProps.pagging, page: 2, search: nextProps.search ? nextProps.search : [],pageType:nextProps.pageType }
        }else if (nextProps.pageInfoData.movies && nextProps.pageInfoData.movies != prevState.movies) {
            return {slideshow:nextProps.pageInfoData.slideshow, movies: nextProps.pageInfoData.movies, pagging: nextProps.pageInfoData.pagging, page: 2, search: nextProps.search ? nextProps.search : [],pageType:nextProps.pageInfoData.pageType }
        } else if (nextProps.pageData.movies && nextProps.pageData.movies != prevState.movies) {
            return {slideshow:nextProps.pageInfoData.slideshow, movies: nextProps.pageData.movies, pagging: nextProps.pageData.pagging, page: 2, search: nextProps.search ? nextProps.search : [],pageType:nextProps.pageInfoData.pageType }
        } else {
            return null
        }
    }
            ...
            <React.Fragment>
                ...
                <div className="cnt-movies">
                    <InfiniteScroll
                            ...
                            loader={<LoadMore {...this.props} page={this.state.page} loading={true} itemCount={this.state.movies.length} />}
                            endMessage={
                                <EndContent {...this.props} text={this.props.pageInfoData.search || this.props.globalSearch ?  Translate(this.props,'No data found with your matching criteria.') : Translate(this.props,'No data found to display.')} itemCount={this.state.movies.length} />
                            }
                            pullDownToRefresh={false}
                            pullDownToRefreshContent={<Release release={false} {...this.props} />}
                            releaseToRefreshContent={<Release release={true} {...this.props} />}
