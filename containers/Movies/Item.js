    ...
    render() {
        ...
        return (
            ...
            <React.Fragment>
                {analyticsData}
                {
                    this.props.pageInfoData.appSettings.movie_advanced_grid != 1 ? 
                    ...
                    <div className="movieList_thumb">
                        <Link href="/watch" customParam={`videoId=${this.state.movie.custom_url}`} as={`/watch/${this.state.movie.custom_url}`}>
                            <a className="ImgBlockRatio-img imgblock" onClick={this.props.closePopUp}>
                                <span>
                                    <Image className="img" title={renderToString(<CensorWord {...this.props} text={this.state.movie.title} />)} image={movieImage} imageSuffix={this.props.pageInfoData.imageSuffix} />
                                </span>
                            </a>
                        </Link> 
                        <div className="btnHover">
                            ...
                            <SocialShare className="share" aTagDirect={true} hideTitle={true} {...this.props} buttonHeightWidth="30" tags={this.state.movie.tags} url={`/watch/${this.state.movie.custom_url}`} title={renderToString(<CensorWord {...this.props} text={this.state.movie.title} />)} imageSuffix={this.props.pageInfoData.imageSuffix} media={this.state.movie.image} />
                        </div>
                                            ...
                                            <li>
                                                {
                                                    ...
                                                    <Link href="/create-movie" customParam={`movieId=${this.state.movie.custom_url}`} as={`/create-movie/${this.state.movie.custom_url}`}>
                                                ...
                                                :
                                                    <Link href="/create-series" customParam={`movieId=${this.state.movie.custom_url}`} as={`/create-series/${this.state.movie.custom_url}`}>
                                                        <a className="addPlaylist addEdit"  title={Translate(this.props, "Edit")}>
                                                        <span className="material-icons" data-icon="edit"></span>
                                                        {Translate(this.props, "Edit")}
                                                        </a>
                ...
                <Link href="/watch" customParam={`videoId=${this.state.movie.custom_url}`} as={`/watch/${this.state.movie.custom_url}`}>
                    <a className="ThumbBox-link" onClick={this.props.closePopUp}>
                        ...
                        <div className="btnPlayListSave">
                            ...
                            <SocialShare className="btnPlayListSave-btn" aTagDirect={true} hideTitle={true} {...this.props} buttonHeightWidth="30" tags={this.state.movie.tags} url={`/watch/${this.state.movie.custom_url}`} title={renderToString(<CensorWord {...this.props} text={this.state.movie.title} />)} imageSuffix={this.props.pageInfoData.imageSuffix} media={this.state.movie.image} />
                        </div>
