...
class Reviews extends React.Component{
    ...
    writeAReview = () => {
        if(this.props.pageInfoData.loggedInUserDetails){
            const reviews = [...this.state.reviews];
            const itemIndex = reviews.findIndex(p => p["owner_id"] == this.props.pageInfoData.loggedInUserDetails.user_id);
            if(itemIndex > -1){
                            ...
                            return (
                                <div key={review.review_id} className='review-container'>
                                    <div className="header">
                                        <div className="image">
                                        <Link href="/member" customParam={`memberId=${review.username}`} as={`/${review.username}`}>
                                            <a>                        
                                                <Image title={review.displayname} image={review.avtar} imageSuffix={this.props.pageInfoData.imageSuffix} />
                                            </a>
                                        </Link>
                                        </div>
                                        <div className="info">
                                            ...
                                            <div className="date">
                                                <Date {...this.props} creation_date={review.creation_date} initialLanguage={this.props.initialLanguage} format={'dddd, MMMM Do YYYY'} defaultTimezone={this.props.pageInfoData.defaultTimezone} />
                                            </div>
                                        ...
                                        {
                                            this.state.canDelete || (this.props.pageInfoData.loggedInUserDetails && this.props.pageInfoData.loggedInUserDetails.user_id == review.owner_id) ?
