...
class Browse extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            loading: false,
            movie_id:props.pageData.movieId,
            season_id:props.pageData.seasonId,
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if (prevState.localUpdate){
            ...
            return {movie:nextProps.pageData.movie,movie_id:nextProps.pageData.movie_id,movieId:nextProps.pageData.seasonId,episodes: nextProps.pageData.episodes, pagging: nextProps.pageData.pagging, page: 2,  }
        } else {
            return null
        }
    }
