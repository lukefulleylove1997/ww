...
class Cast extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            page: 2,
            cast: props.pageInfoData.cast,
            movies: props.pageInfoData.cast_movies ? props.pageInfoData.cast_movies.results : [],
            series: props.pageInfoData.cast_series ? props.pageInfoData.cast_series.results : [],
            moviesPagging: props.pageInfoData.cast_movies ? props.pageInfoData.cast_movies.pagging : false,
            seriesPagging: props.pageInfoData.cast_series ? props.pageInfoData.cast_series.pagging : false,
    ...
    pushTab = (type) => {
        ...
        Router.push(`/cast-and-crew?castncrewId=${this.state.cast.cast_crew_member_id}`, `/cast-and-crew/${this.state.cast.cast_crew_member_id}?type=${type}`,{ shallow: true })
    }
    render() {
                            ...
                            <div className="col-md-12">
                                <div className="details-tab">
                                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        {
                                            this.props.pageInfoData.appSettings[`${"cast_crew_member_comment"}`] == 1 ?
                                                <li className="nav-item">
                                    ...
                                    <div className={`tab-pane fade${this.state.tabType == "about" ? " active show" : ""}`} id="about" role="tabpanel">
                                            <div className="details-tab-box">
                                                <React.Fragment>
                                                {
                                                    this.props.pageInfoData.appSettings[`cast_crew_member_rating`] == 1 ?
                                        ...
                                        </div>
                                        {
                                            this.props.pageInfoData.appSettings[`${"cast_crew_member_comment"}`] == 1 ?
                                                <div className={`tab-pane fade${this.state.tabType == "comments" ? " active show" : ""}`} id="comments" role="tabpanel">
                                                    <div className="details-tab-box">
                                                        <Comment  {...this.props}  owner_id="artist" hideTitle={true} appSettings={this.props.pageInfoData.appSettings} commentType="cast_crew_member" type="cast_crew_members" id={this.state.cast.cast_crew_member_id} />
                                                    </div>
                                                </div>
                                                : null
                                        }
