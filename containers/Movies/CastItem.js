        ...
        return (
            <div className="single-user">
                <div className={`img${this.props.className ? " "+this.props.className : ""}`}>
                    <Link href="/cast-and-crew" customParam={`castncrewId=${this.state.cast.cast_crew_member_id}`} as={`/cast-and-crew/${this.state.cast.cast_crew_member_id}`}>
                        <a>                        
                            <Image title={renderToString(<CensorWord {...this.props} text={this.state.cast.name} />)} image={this.state.cast.image} imageSuffix={this.props.pageInfoData.imageSuffix} />
                        </a>
                    </Link>
                </div>
                    <div className="content">
                        ...
                        {
                        this.props.pageInfoData.appSettings["cast_crew_member_like"] == "1" ?
                            <li>
                        ...
                        {
                            this.props.pageInfoData.appSettings["cast_crew_member_dislike"] == "1" ?
                            <li>
                        ...
                        : null
                            ...
                            {
                                this.props.pageInfoData.appSettings["cast_crew_member_favourite"] == "1" ?
                            <li>
                        ...
                        <SocialShare {...this.props} hideTitle={true} buttonHeightWidth="30" url={`/cast-and-crew/${this.state.cast.cast_crew_member_id}`} title={renderToString(<CensorWord {...this.props} text={Translate(this.props,this.state.cast.name)} />) } imageSuffix={this.props.pageInfoData.imageSuffix} media={this.state.cast.image} />
