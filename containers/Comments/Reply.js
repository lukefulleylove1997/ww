...
class Reply extends React.Component{
    ...
    render(){
        ...
        return (
            <React.Fragment>
                <Header {...this.props} linkify={this.linkify} textHeading="Show replies for:" title={this.state.item.title} item={this.state.item} image={this.state.comments[0].type == "members" ? this.state.item.avtar : this.state.item.image} type={this.state.comments[0].type} />
