...
class VideoSlider extends React.Component {
    ...
    render() {
        ...
        var settings = {
            ...
            prevArrow:<Left />,
            centerMode: true,
            centerPadding: this.props.pageInfoData.themeType == 2 ? '4%' : 0
          };
        return (
            
            <div className={`SlideAdsWrap${this.props.pageInfoData.appSettings['video_adv_slider'] == 1 ? " nobtn" : ""}`}>
                ...
                <Carousel {...settings} >
                {
                   this.state.videos.map(item => {
                        ...
                        return(
                            this.props.pageInfoData.appSettings['video_adv_slider'] != 1 ? 
