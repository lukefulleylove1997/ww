        ...
        return (
            <div className="VideoRoWrap">
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            {
                                <Carousel {...this.props} items={content} carouselType="user" itemAt1024={this.props.pageInfoData.appSettings["audio_advgrid"] == 1 ? 5 : 4} itemAt1200={this.props.pageInfoData.appSettings["audio_advgrid"] == 1 ? 4 : 4} itemAt900={this.props.pageInfoData.appSettings["audio_advgrid"] == 1 ? 4 : 3} itemAt600={this.props.pageInfoData.appSettings["audio_advgrid"] == 1 ? 2 : 2} itemAt480={this.props.pageInfoData.appSettings["audio_advgrid"] == 1 ? 2 : 1} >
                                    {content}
                                </Carousel>
                            }
                        </div>
