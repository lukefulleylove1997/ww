            ...
            <div className="VideoRoWrap">
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            {
                                <Carousel {...this.props} carouselType="audio" defaultItemCount={this.props.pageInfoData.appSettings["audio_advgrid"] == 1 ? 5 : 5} itemAt1024={this.props.pageInfoData.appSettings["audio_advgrid"] == 1 ? 4 : 4} itemAt900={this.props.pageInfoData.appSettings["audio_advgrid"] == 1 ? 3 : 3} itemAt1200={3} itemAt1500={this.props.pageInfoData.appSettings["audio_advgrid"] == 1 ? 5 : 5} itemAt600={this.props.pageInfoData.appSettings["audio_advgrid"] == 1 ? 2 : 2} itemAt480={1} >
                                    {content}
                                </Carousel>
                            }
                        </div>
