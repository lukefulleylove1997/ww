    ...
    render() {
        ...
        return (
            <React.Fragment>
                {analyticsData}
                {
                    this.props.pageInfoData.appSettings.channel_advanced_grid != 1 ? 
                        ...
                        <a className="ThumbBox-link" onClick={this.props.closePopUp}>
                            ...
                            <div className="ThumbBox-Title hide-on-expand">
                                <div className="title ellipsize2Line">
                                    <h4 className="m-0">{<CensorWord {...this.props} text={this.state.channel.title} />}</h4>
                                </div>
                            </div>
                                ...
                                </div>
                                {
                                        this.props.pageInfoData.appSettings['channels_browse_subscribe'] == 1 ? 
                                            <div className="cn-subscribe">
                                                <ChannelFollow  {...this.props}  hideButton={true} className="subscribe" title={this.state.channel.follower_id ? Translate(this.props,"Subscribed") : Translate(this.props,"Subscribe")} type="channels" user={this.state.channel} user_id={this.state.channel.follower_id} />
                                            </div>
                                        : null
                                }
