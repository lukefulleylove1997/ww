            ...
            <div className="VideoRoWrap">
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
                            <div className="titleWrap">
                                {
                                this.props.pageInfoData.themeType == 2 && this.props.seemore && ( this.props.type || this.props.sort ) ?
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            {
                                <Carousel {...this.props} items={content} carouselType="channel" itemAt1024={this.props.pageInfoData.themeType == 2 ? 4 : 3} itemAt600={this.props.pageInfoData.themeType == 2 ? 3 : 2} itemAt480={this.props.pageInfoData.themeType == 2 ? 2 : 1}  />
                            }
                        </div>
                    </div>
